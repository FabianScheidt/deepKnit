...
COLOR_NUMBERS[8] = ColorNumber(LINKS, BACK, KNIT, FRONT_TO_BACK, -1, BACK_TO_FRONT, FRONT_TO_BACK)
COLOR_NUMBERS[9] = ColorNumber(LINKS, BACK, KNIT, FRONT_TO_BACK, 1, BACK_TO_FRONT, FRONT_TO_BACK)
...
COLOR_NUMBERS[20] = ColorNumber(NO_TRANSFER, FRONT, KNIT, FRONT_TO_BACK)
COLOR_NUMBERS[21] = ColorNumber(NO_TRANSFER, FRONT, KNIT, NO_TRANSFER, 1, FRONT_TO_BACK, BACK_TO_FRONT)
COLOR_NUMBERS[22] = ColorNumber(NO_TRANSFER, FRONT, KNIT, NO_TRANSFER, 2, FRONT_TO_BACK, BACK_TO_FRONT)
COLOR_NUMBERS[23] = ColorNumber(NO_TRANSFER, FRONT, KNIT, NO_TRANSFER, 3, FRONT_TO_BACK, BACK_TO_FRONT)
COLOR_NUMBERS[24] = ColorNumber(NO_TRANSFER, FRONT, KNIT, NO_TRANSFER, -1, FRONT_TO_BACK, BACK_TO_FRONT)
COLOR_NUMBERS[25] = ColorNumber(NO_TRANSFER, FRONT, KNIT, NO_TRANSFER, -2, FRONT_TO_BACK, BACK_TO_FRONT)
COLOR_NUMBERS[26] = ColorNumber(NO_TRANSFER, FRONT, KNIT, NO_TRANSFER, -3, FRONT_TO_BACK, BACK_TO_FRONT)
COLOR_NUMBERS[29] = ColorNumber(NO_TRANSFER, FRONT, KNIT, BACK_TO_FRONT)
...
COLOR_NUMBERS[65] = ColorNumber(LINKS, FRONT, MISS, FRONT_TO_BACK, -1, BACK_TO_FRONT)
COLOR_NUMBERS[66] = ColorNumber(LINKS, FRONT, MISS, FRONT_TO_BACK, -2, BACK_TO_FRONT)
COLOR_NUMBERS[67] = ColorNumber(LINKS, FRONT, MISS, FRONT_TO_BACK, -4, BACK_TO_FRONT)
...
COLOR_NUMBERS[75] = ColorNumber(LINKS, FRONT, MISS, FRONT_TO_BACK, 1, BACK_TO_FRONT)
COLOR_NUMBERS[76] = ColorNumber(LINKS, FRONT, MISS, FRONT_TO_BACK, 2, BACK_TO_FRONT)
COLOR_NUMBERS[77] = ColorNumber(LINKS, FRONT, MISS, FRONT_TO_BACK, 4, BACK_TO_FRONT)
COLOR_NUMBERS[81] = COLOR_NUMBERS[8]
COLOR_NUMBERS[82] = ColorNumber(LINKS, BACK, KNIT, FRONT_TO_BACK, -2, BACK_TO_FRONT, FRONT_TO_BACK)
COLOR_NUMBERS[83] = ColorNumber(LINKS, BACK, KNIT, FRONT_TO_BACK, -3, BACK_TO_FRONT, FRONT_TO_BACK)
COLOR_NUMBERS[84] = ColorNumber(LINKS, BACK, KNIT, FRONT_TO_BACK, -4, BACK_TO_FRONT, FRONT_TO_BACK)
COLOR_NUMBERS[85] = ColorNumber(LINKS, BACK, MISS, FRONT_TO_BACK, -1, BACK_TO_FRONT, FRONT_TO_BACK)
COLOR_NUMBERS[86] = ColorNumber(LINKS, BACK, MISS, FRONT_TO_BACK, -2, BACK_TO_FRONT, FRONT_TO_BACK)
COLOR_NUMBERS[87] = ColorNumber(LINKS, BACK, MISS, FRONT_TO_BACK, -4, BACK_TO_FRONT, FRONT_TO_BACK)
COLOR_NUMBERS[91] = COLOR_NUMBERS[9]
COLOR_NUMBERS[92] = ColorNumber(LINKS, BACK, KNIT, FRONT_TO_BACK, 2, BACK_TO_FRONT, FRONT_TO_BACK)
COLOR_NUMBERS[93] = ColorNumber(LINKS, BACK, KNIT, FRONT_TO_BACK, 3, BACK_TO_FRONT, FRONT_TO_BACK)
COLOR_NUMBERS[94] = ColorNumber(LINKS, BACK, KNIT, FRONT_TO_BACK, 4, BACK_TO_FRONT, FRONT_TO_BACK)
COLOR_NUMBERS[95] = ColorNumber(LINKS, BACK, KNIT, FRONT_TO_BACK, 1, BACK_TO_FRONT, FRONT_TO_BACK)
COLOR_NUMBERS[96] = ColorNumber(LINKS, BACK, KNIT, FRONT_TO_BACK, 2, BACK_TO_FRONT, FRONT_TO_BACK)
COLOR_NUMBERS[97] = ColorNumber(LINKS, BACK, KNIT, FRONT_TO_BACK, 4, BACK_TO_FRONT, FRONT_TO_BACK)
