...
class KnitPaint:
    ...
    def __init__(self, input_file=None):
        ...
        self.header_color_table = 1000
        self.header_package_type = 0
        self.header_use_color_number_of_package = 0
        self.header_line_number_of_compressed_package = 0
        self.header_compress_flag = 1000
        self.header_scramble_flag = 0
        self.header_saving_attribute = 0
        self.header_comments_of_package = bytes([0] * 64)
        self.header_free_color_information = bytes([0] * 308)
