...
class SlidingWindowModel:
    ...
    def read_vocab():
        # Read vocabulary
        vocab = np.load('../data/processed/training-files/sliding-window/vocab.npy')
    ...
    def train(self):
        ...
        inputs_layer = keras.layers.Input(shape=(input_data.shape[1], input_data.shape[2], ), name='inputs_layer')
        ...
        # Output
        dense_output = keras.layers.Dense(vocab_size, activation='softmax', name='dense_output')(dropout_3)
        ...
        try:
            ...
            model.fit(input_data, output_data,
                      epochs=500, batch_size=8192, verbose=1,
    ...
    def sample(self, width, start_string, temperature, num_generate):
        ...
        model = keras.models.load_model('sliding-window-model.h5')
